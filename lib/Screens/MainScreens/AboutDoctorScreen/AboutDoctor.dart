...
class Aboutdoctor extends StatelessWidget {
  ...
  Aboutdoctor({Key? key, this.DoctId, this.Spid})
      : aboutController = Get.put(Aboutdoctorcontroller(Spid, DoctId)),
        super(key: key);
                      ...
                      children: [
                        Expanded(
                            ...
                            SingleChildScrollView(
                              child: Column(
                                children: [
                                  aboutController.AvailableTimelist.length==0?Text("No data"):
                                  ...
                                  Container(
                                    ...
                                    child: GridView.builder(
                                        ...
                                        itemCount:aboutController.AvailableTimelist.length, // Number of items
                                        itemBuilder: (context, index) {
                                          final TimeSlot=aboutController.AvailableTimelist[index];
