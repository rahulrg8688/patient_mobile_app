class GetDoctorBookings {
  int? appointmentId;
  bool? isAdmission;
  bool? isFollowUpCompleted;
  dynamic encounterId;
  dynamic encryptedAppointmentId;
  dynamic encryptedPatientId;
  dynamic encryptedProviderId;
  int? providerLocationId;
  int? providerId;
  String? providerName;
  dynamic reason;
  dynamic providerGender;
  dynamic providerAge;
  dynamic providerThumbnailUrl;
  dynamic appointmentEndTime;
  dynamic practiceName;
  dynamic providerLocation;
  ...
  dynamic enableEmailAlerts;
  dynamic enableSMSAlerts;
  dynamic enableDesktopNotifications;
  dynamic enableMobileNotifications;
  dynamic patientThumbnailUrl;
  int? patientAge;
  int? patientCountryId;
  dynamic patientCountryCode;
  int? providerCountryId;
  dynamic providerCountryCode;
  dynamic visitType;
  dynamic patientType;
  dynamic chargeType;
  dynamic appointmentNo;
  dynamic previousAppointmentNo;
  dynamic previousAdmissionNo;
  dynamic appointmentDate;
  dynamic appointmentPreviousDate;
  dynamic admissionDischargeDate;
  dynamic admissionDischargeTime;
  dynamic appointmentPreviousTime;
  dynamic appointmentTime;
  dynamic appointmentDateTime;
  dynamic oldAppointmentDateTime;
  dynamic appointmentTimeString;
  dynamic previousAppointmentTimeString;
  dynamic previousAdmissionDischargeTimeString;
  ...
  dynamic patientGuid;
  dynamic providerGuid;
  dynamic patientDocumentCount;
  int? callStatus;
  dynamic callStatusText;
  dynamic patientCallStatus;
  dynamic callerName;
  ...
  bool? isOnline;
  dynamic delay;
  dynamic patientFamilyId;
  int? logFrom;
  dynamic doctorMessageCount;
  dynamic patientMessageCount;
  double? walletAmount;
  int? departmentId;
  dynamic departmentName;
  dynamic umrNo;
  dynamic patientMaritalStatus;
  bool? paymentStatus;
  dynamic paymentType;
  dynamic payTypeName;
  dynamic paymentNumber;
  dynamic isActiveAdmissionExists;
  dynamic streetAddress;
  dynamic city;
  dynamic state;
  dynamic zipcode;
  dynamic followUpForAppointmentId;
  dynamic followUpForAdmissionId;
  dynamic followUpDays;
  dynamic freeVisitsCount;
  dynamic freeFollowUpDaysLimit;
  dynamic freeFollowUpDays;
  dynamic startDate;
  dynamic endDate;
  dynamic startTime;
  dynamic endTime;
  ...
  dynamic queueStatus;
  int? queueStatusId;
  dynamic fatherOrHusband;
  dynamic chargeTypesName;
  int? payType;
  dynamic locationName;
  dynamic specializationNames;
  dynamic languages;
  int? appointmentTypeId;
  int? payTypeId;
  int? tokenNumber;
  dynamic patientReferredName;
  dynamic waitingCount;
  dynamic emailDetailsId;
  dynamic emailHeadersId;
  dynamic replyEmailDetailsId;
  dynamic patientDateOfBirth;
  dynamic statusName;
  int? appointmentStatusId;
  bool? isCc;
  dynamic telemedicineIds;
  dynamic callerRoleId;
  dynamic isUTC;
  ...
  dynamic isTaskDone;
  dynamic noOfEmails;
  dynamic isPanicOption;
  dynamic callStatusDate;
  dynamic callStatusModifiedDate;
  dynamic inProgress=false;
  dynamic callStatusName;
  int? callType;
  dynamic callTypeName;
  dynamic callerCallStatus;
  dynamic callerCallStatusName;
  dynamic receiverCallStatus;
  dynamic receiverCallStatusName;
  dynamic callerCallStatusDate;
  dynamic receiverCallStatusDate;
  dynamic telemedicineDuration;
  dynamic isRequireEmergencyAppointment;
  dynamic activeUsers;
  dynamic idProofName;
  dynamic idProofValue;
  dynamic appointmentTypeName;
  dynamic queueEndDate;
  dynamic queueStartDate;
  dynamic minutes;
  bool? patientPaymentStatus;
  dynamic patientRegistrationAmount;
  dynamic visitorName;
  ...
  bool? isEncounter;
  dynamic cubicleName;
  dynamic receiptCreatedByName;
  dynamic receiptDate;
  int? aptRefundAmt;
  dynamic receiptId;
  dynamic cancelType;
  dynamic transaction;
  dynamic salucroStatusCode;
  dynamic salucroTransactionId;
  dynamic message;
  int? messageCount;
  dynamic totalAmount;
  dynamic charges;
  bool? isSalucroAppointment;
  dynamic doctorSpecializationChargeModuleDetailsId;
  dynamic referenceId;
  dynamic patientSalutation;
  dynamic patientRelation;
  dynamic area;
  dynamic lastConsultedDate;
  dynamic lastConsultedDoctor;
  double? lastPaidAmount;
  dynamic nextAppointment;
  dynamic hwcCategory;
  dynamic followUpValidityDate;
  dynamic lastConsultedTime;
  dynamic otherRemarks;
  dynamic authorityId;
  dynamic reasonId;
  dynamic remarks;
  dynamic encounterName;
  dynamic moduleType;
  dynamic typeOfPayment;
  bool? isEmergency;
  dynamic mapUrl;
  int? transactionCount;
  dynamic consultationName;
  dynamic isAppointmentClosed;
  dynamic patientDiscountInPercentage;
  dynamic patientDiscountInRupees;
  dynamic patientTotal;
  dynamic appointmentDiscountInPercentage;
  ...
  int? afterDiscount;
  dynamic isHealthCard;
  dynamic addressLine2;
  dynamic sessionId;
  dynamic slotCount;
  dynamic isEncounterClosed;
  dynamic urlLink;
  bool? isMobile;
  bool? isDischarged;
  ...
  dynamic patDiscount;
  dynamic patTotal;
  dynamic packageModuleDetailId;
  dynamic packageAppointmentId;
  dynamic admissionPackageId;
  bool? isFromPackage;
  bool? followUpSpecialization;
  dynamic fromDate;
  dynamic toDate;
  dynamic patientsOrganization;
  dynamic receptionist;
  dynamic doctorName;
  dynamic branchName;
  dynamic contactNumber;
  dynamic emergencyTriage;
  dynamic nursingERForm;
  bool? isHdfcAppt;
  dynamic paymentLink;
  dynamic encounterTypes;
  ...
  GetDoctorBookings.fromJson(Map<String, dynamic> json) {
